...
import com.example.uom.databinding.ItemAdviceBinding;
import com.example.uom.model.Advice;
...
public class AdviceAdapter extends RecyclerView.Adapter<AdviceAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(ItemAdviceBinding.inflate(LayoutInflater.from(context),
                parent, false));
    }
